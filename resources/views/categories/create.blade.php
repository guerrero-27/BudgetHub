            ...
            <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-4 gap-3 mb-4">
                        ...
                        <label class="cursor-pointer">
                            <input type="radio" name="color" value="{{ $colorName }}" 
                                   {{ old('color') === $colorName ? 'checked' : '' }}
                                   class="sr-only peer" required>
                            <div class="color-option px-4 py-3 text-center border-2 border-gray-200 rounded-lg 
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="flex items-center gap-3">
                        <div id="previewBadge" class="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center">
                            <span id="previewInitial" class="text-green-600 font-bold text-xl">?</span>
                        </div>
                        <div>
                            <span id="previewName" class="font-semibold text-gray-900">Category Name</span>
                            <span id="previewColorBadge" class="ml-2 px-2 py-0.5 text-xs rounded-full bg-green-100 text-green-700">
                                green
                            </span>
                        </div>
                    </div>
